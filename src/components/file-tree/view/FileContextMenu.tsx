...
import { ClipboardPaste, Copy, Download, FileText, FolderPlus, Pencil, RefreshCw, Scissors, Trash2, Upload, type LucideIcon } from 'lucide-react';
...
export default function FileContextMenu({
  ...
  const menuActions = useMemo<ContextMenuAction[]>(() => {
    ...
    return actions;
  }, [item, onCopyPath, onCut, onDelete, onDownload, onNewFile, onNewFolder, onPaste, onRefresh, onRename, onUpload, t]);
